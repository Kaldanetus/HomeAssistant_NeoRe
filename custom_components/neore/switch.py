...
from .entity import NeoReEntity, controller_has_pool, pool_is_exposed
...
async def async_setup_entry(
    ...
    # Some NeoRé firmware omits the writable mazenmainon object from getlist,
    # even though setobject accepts it. Advertise the control whenever another
    # pool object proves that pool support is present.
    if controller_has_pool(coordinator) and pool_is_exposed(coordinator):
        entities.append(
